...
We will check the spread of variation for taxa identifed using both approaches. Coefficient of variation, i.e. sd(x)/mean(x) is a widely used approach to measure spread in the data.  
