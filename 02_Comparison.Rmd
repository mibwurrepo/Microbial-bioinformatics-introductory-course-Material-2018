...
For NG-Tax, we used the same raw data and processed through default settings.  
...
Let us check for distribution of numer of sequences retained after OTU picking and NG-tax approach.  
