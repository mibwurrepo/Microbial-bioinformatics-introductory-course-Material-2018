...
# From a to d, we have layered the plot with new features, power of ggplot2.  
...
Although these all are host-associated samples, there is large variation in microbiota composition between body sites.   
